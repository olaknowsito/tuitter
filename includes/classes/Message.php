<?php
    class Message {
        ...
        public function getMostRecentUser() {
            ...
            //LIMIT 1 RESOLVE REVSER BECAuse most recent
        ...
        public function getConvos() {
            ...
            $return_string = "";
            $convos = array();
            //select all the name to and from 
            ...
            foreach($convos as $username) {
                ...
                //we have pushed 3 arrays from another method
                ...
                $return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
                                    <img src='" . $user_found_obj->getProfilePic() . "' style='border-radius: 5px; margin-right: 6px;'>
